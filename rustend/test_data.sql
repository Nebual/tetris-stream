DELETE FROM inventory_item WHERE id = 9000 or template_id = 9000;
...
INSERT INTO inventory_item (id, template_id, name, width)
    VALUES (9000, 9000, 'test item override', 42);
